...
class TestFeedbackTranslator(unittest.TestCase):
    def test_translate(self):
        ...
        self.assertTrue(all(isinstance(q, Answer) for q in feedback.questions[0].answers))
        self.assertEqual(feedback.questions[0].answers[0].value, "value")
        self.assertEqual(feedback.questions[0].answers[0].type, "type")
        self.assertEqual(feedback.questions[0].answers[0].text, "label")
