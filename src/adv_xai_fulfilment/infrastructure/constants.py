class Errors:
    ...
    PARTNER_NOT_EMPTY  = TypeError("partner can't be empty")
    ...
    DATA_FOR_TRAIN_FOLDER_NOT_STRING = TypeError("data_for_train folder must be a string")
    DATA_FOR_PREDICT_FOLDER_NOT_STRING = TypeError("data_for_predict folder must be a string")
